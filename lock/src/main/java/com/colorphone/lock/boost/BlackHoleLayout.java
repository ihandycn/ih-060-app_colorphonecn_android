...
public class BlackHoleLayout extends RelativeLayout {
    ...
    private BoostSource mBoostSource = BoostSource.STANDALONE_ACTIVITY;

    private BlackHoleAnimationListener listener;

    private AcbNativeAd mAd = null;
    private boolean mBoostTipShown;
    ...
    public void startAnimation() {
        // Ram usage text
        mAfterBoostRamUsage = RamUsageDisplayUpdater.getInstance().startBoost(false);

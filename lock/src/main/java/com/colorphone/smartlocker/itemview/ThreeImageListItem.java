...
public class ThreeImageListItem implements IDailyNewsListItem<RecyclerView.ViewHolder> {
    ...
    public void bindViewHolder(final Context context, RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LockerCustomConfig.getLogger().logEvent("feed_news_clicked", "place", "daily", "content", "threeimg", "channel", category);
    ...
    public void logViewedEvent() {
        if (!hasViewed) {
            ...
            LockerCustomConfig.getLogger().logEvent("feed_news_viewed", "place", "daily", "content", "threeimg", "channel", category);
        }
    }

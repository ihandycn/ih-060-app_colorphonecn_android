...
public class NetworkStatusUtils {
    ...
    public static void showNoNetworkToast() {
        if (!isToastShowing) {
            isToastShowing = true;
//            Toast.makeText(HSApplication.getContext(), R.string.toast_no_network, Toast.LENGTH_SHORT).show();
            handler.sendEmptyMessageDelayed(0, 4000L);
        }
    }

    public static void showNoNetworkToast(String toast) {
        if (!isToastShowing) {
            isToastShowing = true;
    ...
    public static boolean isNetworkConnected() {
        return isNetworkConnected(HSApplication.getContext());
    }

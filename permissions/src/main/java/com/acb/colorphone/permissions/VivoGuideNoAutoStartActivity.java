...
public class VivoGuideNoAutoStartActivity extends LottiePermissionGuideActivity {
    ...
    protected String getImageAssetFolder() {
        return "lottie/vivo_permissions_guide_no_autostart/images/";
    }

    @Override
    protected String getAnimationFromJson() {
        return "lottie/vivo_permissions_guide_no_autostart/data.json";
    }

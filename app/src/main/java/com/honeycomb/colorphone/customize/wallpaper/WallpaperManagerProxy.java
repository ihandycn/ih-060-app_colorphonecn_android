...
public class WallpaperManagerProxy {
    ...
    private void setSystemBitmap(Context context, Bitmap wallpaper, boolean scrollable) throws IOException {
        ...
        if (DebugMode.MANAGER_PROXY_DEBUG) {
            HSLog.i("screensz " + Dimensions.getPhoneWidth(context) + " " + Dimensions.getPhoneHeight(context));
            HSLog.i("scrollable " + scrollable + " wallpaper " + wallpaper.getWidth() + " " + wallpaper.getHeight());
        }
        try {
            if (scrollable) {
        ...
        if (DebugMode.MANAGER_PROXY_DEBUG) {
            HSLog.i("wallpaper " + scrollable + " wallpaper " + wallpaper.getWidth() + " " + wallpaper.getHeight());
        }
        if (wallpaper != null) {
            try {
                try {
        ...
        if (DebugMode.MANAGER_PROXY_DEBUG) {
            HSLog.i("wallpaper setSystemBitmap finish ");
        }
    }

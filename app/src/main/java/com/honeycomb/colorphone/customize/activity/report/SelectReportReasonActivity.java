...
public class SelectReportReasonActivity extends BaseCustomizeActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallpaper_report_reason);
    ...
    private String getReportReason(@IdRes int id) {
        switch (id) {
            case R.id.reason_infringement:
                return "infringement";
            case R.id.reason_political:
                return "political";
            case R.id.reason_gambling:
                return "gambling";
            case R.id.reason_porn:
                return "porn";
            case R.id.reason_violence:
                return "violence";
        }
        return "";
    }

...
public class WallpaperProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com." + "colorphone.smooth.dialer.cn.wallpaper";
    ...
    public Bundle call(@NonNull String method, String arg, Bundle extras) {
        if (method.equals(METHOD_APPLY_WALLPAPER)) {
            ...
            extras.setClassLoader(ColorPhoneActivity.class.getClassLoader());
    ...
    private static class WallpaperDB extends SQLiteOpenHelper {
        ...
        WallpaperDB(Context context) {
            super(context, CustomizeConstants.WALLPAPER_DB, null, DB_VERSION);
        }

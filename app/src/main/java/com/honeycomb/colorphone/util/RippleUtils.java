...
public class RippleUtils {
    ...
    public static Drawable createRippleDrawable(int shapeColor, int radius) {
        return createRippleDrawable(shapeColor, HSApplication.getContext().getResources().getColor(R.color.white_40_transparent), radius);
    }
    ...
    public static Drawable createRippleDrawable(GradientDrawable shape, int shapeColor) {
        return createRippleDrawable(shape, shapeColor, HSApplication.getContext().getResources().getColor(R.color.white_40_transparent), 0, null);
    }
}

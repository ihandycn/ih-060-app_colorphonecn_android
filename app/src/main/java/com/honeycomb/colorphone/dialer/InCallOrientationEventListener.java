...
public class InCallOrientationEventListener extends OrientationEventListener {
  ...
  public void enable(boolean notifyDeviceOrientationChange) {
    if (enabled) {
      Log.d(this.toString(), "enable: Orientation listener is already enabled. Ignoring...");
      return;
    }
  ...
  public void disable() {
    if (!enabled) {
      Log.d(this.toString(), "enable: Orientation listener is already disabled. Ignoring...");
      return;
    }

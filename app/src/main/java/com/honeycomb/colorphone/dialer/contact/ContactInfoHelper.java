...
import com.honeycomb.colorphone.dialer.util.UriUtils;
...
//    cachedNumberLookupService = PhoneNumberCache.get(this.context).getCachedNumberLookupService();
  ...
  public static String lookUpDisplayNameAlternative(
          Context context, String lookupKey, @ContactsUtils.UserType long userType, @Nullable Long directoryId) {
    // Query {@link Contacts#CONTENT_LOOKUP_URI} directly with work lookup key is not allowed.
    if (lookupKey == null || userType == ContactsUtils.USER_TYPE_WORK) {
      return null;
    }

    if (directoryId != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
...
//      }
      ...
      CachedNumberLookupService.CachedContactInfo cacheInfo =

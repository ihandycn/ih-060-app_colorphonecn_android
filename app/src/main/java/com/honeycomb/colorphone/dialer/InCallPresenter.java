  ...
  private final android.telecom.Call.Callback callCallback =
      new android.telecom.Call.Callback() {
        ...
        public void onConferenceableCallsChanged(
            android.telecom.Call telecomCall, List<Call> conferenceableCalls) {
          LogUtil.i(
...
//      manageConferenceActivity = null;
   ...
   */
  public void onDeviceOrientationChange(@InCallOrientationEventListener.ScreenOrientation int orientation) {
    LogUtil.d(
  ...
  public interface InCallOrientationListener {
    ...
    void onDeviceOrientationChanged(@InCallOrientationEventListener.ScreenOrientation int orientation);
  }

...
package com.honeycomb.colorphone.dialer.ringtone;
...
import com.honeycomb.colorphone.dialer.async.PausableExecutor;
...
public class InCallTonePlayer {
  ...
  private void playOnBackgroundThread(ToneGeneratorInfo info) {
    ...
    try {
      ...
      HSLog.d("Interrupted while playing in-call tone.");
    } finally {

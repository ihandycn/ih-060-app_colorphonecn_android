...
public class BoostIcon {
    ...
    @ColorInt public static final int RED_COLOR = 0xfff32222;
    @ColorInt public static final int ORANGE_COLOR = 0xfffb9400;
    @ColorInt public static final int GREEN_COLOR = 0xff00c176;

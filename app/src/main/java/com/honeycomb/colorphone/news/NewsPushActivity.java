...
//            Analytics.logEvent("news_alert_settings_click");
//        });
//
...
//            Analytics.logEvent("news_alert_morebtn_click", "type", NewsTest.getNewsAlertType());
//        });
//
...
//        Analytics.logEvent("news_alert_show", "type", NewsTest.getNewsAlertType());
...
//                    Analytics.logEvent("news_alert_slide", "type", NewsTest.getNewsAlertType());
//                }
//            }
//
...
//                Analytics.logEvent("news_alert_news_click", "type", NewsTest.getNewsAlertType());
//            });
//        }
//
...
//
//                finish();
//                Analytics.logEvent("news_alert_settings_disable_success");

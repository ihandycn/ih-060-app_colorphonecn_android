...
public class CropImageOptions implements Parcelable {
    static final String TAG = "Crop";
    static final boolean DEBUG = false && BuildConfig.DEBUG;
    ...
    public CropImageOptions() {
        ...
        snapRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6, dm);
        touchRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 34, dm);
        ...
        borderLineThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, dm);
        borderLineColor = Color.argb(204, 255, 255, 255);
        borderCornerThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, dm);
        borderCornerOffset = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1, dm);
        ...
        minCropWindowWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 110, dm);
        minCropWindowHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 110, dm);

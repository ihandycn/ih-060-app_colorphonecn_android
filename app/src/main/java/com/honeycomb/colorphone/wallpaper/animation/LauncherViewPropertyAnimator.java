...
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener {
    ...
    @Override
    public void end() {
        // No-op. This could be called when device animator scale (in Developer options) is set to
        // "Animation off". We just let this animation finish normally in such case.
    }

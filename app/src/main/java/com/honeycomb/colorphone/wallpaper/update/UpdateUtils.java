...
public class UpdateUtils {
    ...
    static boolean isLocalApkReadyAndLatest(String apkPath, Context context) {
        ...
        if (apkInfo.packageName.equals(localPackage)) {
            try {
                ...
                if (apkInfo.versionCode > packageInfo.versionCode && apkInfo.versionCode >= com.honeycomb.colorphone.wallpaper.util.Utils.getLatestVersionCode()) {
                    return false;
                }
    ...
    public static boolean update(final Activity context) {
        if (com.honeycomb.colorphone.wallpaper.util.Utils.hasUpdate()) {

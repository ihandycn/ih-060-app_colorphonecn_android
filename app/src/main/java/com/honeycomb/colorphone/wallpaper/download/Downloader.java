...
import com.honeycomb.colorphone.wallpaper.util.DiskLruCacheWrapperFixed;
...
public class Downloader {
                                ...
                                if (revokeDownloadingStatus()) {
                                    ...
                                    if (connectionSucceeded) {
                                        if (task.isLimitedByLru()) {
                                            ...
                                            try {
                                                Utils.copyFile(output, new File(path));
                                            } catch (IOException e) {
    ...
    public static String getDownloadPath(String directory, String url) {
        return new File(CommonUtils.getDirectory(directory),

...
import com.honeycomb.colorphone.wallpaper.customize.CategoryItem;
...
import com.honeycomb.colorphone.wallpaper.customize.adapter.CategoryViewAdapter;
...
import com.honeycomb.colorphone.wallpaper.util.LauncherConfig;
...
public class OnlineWallpaperPage extends RelativeLayout {
    ...
    public void setup(int initialTabIndex) {
        ...
        com.honeycomb.colorphone.wallpaper.util.Utils.configTabLayoutText(mTabs, Fonts.getTypeface(Fonts.Font.CUSTOM_FONT_SEMIBOLD), 14f);
        mTabs.setOnScrollListener((isScrollLeft, isScrollRight) -> LauncherAnalytics.logEvent("Wallpaper_TopTab_Slided"));

        int indexAbsolute = com.honeycomb.colorphone.wallpaper.util.Utils.mirrorIndexIfRtl(mIsRtl, mAdapter.getCount(), initialTabIndex);
    ...
    private class WallpaperPagerAdapter extends PagerAdapter {
        ...
        public CharSequence getPageTitle(int positionAbsolute) {
            int position = com.honeycomb.colorphone.wallpaper.util.Utils.mirrorIndexIfRtl(mIsRtl, getCount(), positionAbsolute);
        ...
        private OnlineWallpaperListView createSingleCategoryTabContent(final int categoryIndex) {
            ...
            int position = categoryIndex + (CustomizeConfig.getBoolean(true, "IsHotEnabled") ?
                    0 : mTabsConfig.extraTabsCount);
            int positionAbsolute = com.honeycomb.colorphone.wallpaper.util.Utils.mirrorIndexIfRtl(mIsRtl, getCount(), position);

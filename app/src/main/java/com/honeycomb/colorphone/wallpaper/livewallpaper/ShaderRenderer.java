...
import com.honeycomb.colorphone.wallpaper.GLParams;
...
import com.honeycomb.colorphone.wallpaper.livewallpaper.confetti.render.RenderThread;
import com.honeycomb.colorphone.wallpaper.livewallpaper.guide.FakeGravity;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.AccelerometerListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.CameraListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.GyroscopeListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.LightListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.MagneticFieldListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.PressureListener;
import com.honeycomb.colorphone.wallpaper.livewallpaper.hardware.ProximityListener;
...
public class ShaderRenderer implements GLSurfaceView.Renderer {
    ...
    @Thunk
    static final int TEXTURE_UNITS[] = {
			GLES20.GL_TEXTURE0,
			GLES20.GL_TEXTURE1,
			GLES20.GL_TEXTURE2,
			GLES20.GL_TEXTURE3,
...
//				true);
	...
	public static class TextureBinder {
		...
		@Thunk
        void bind(int loc, int target, int textureId, int textureSizeLoc, int[] textureSize) {

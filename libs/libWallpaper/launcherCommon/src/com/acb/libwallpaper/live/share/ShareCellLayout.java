...
public class ShareCellLayout extends ViewGroup
{
    ...
    public ShareCellLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ShareCellLayout(Context context, AttributeSet attrs, int defStyle) {

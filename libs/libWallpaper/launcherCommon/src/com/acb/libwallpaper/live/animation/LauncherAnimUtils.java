...
public class LauncherAnimUtils {
    ...
    public static final TimeInterpolator ACCELERATE_QUAD =
            AnimationUtils.loadInterpolator(HSApplication.getContext(), R.interpolator.accelerate_quad);
    ...
    public static final TimeInterpolator DECELERATE_QUINT =
            AnimationUtils.loadInterpolator(HSApplication.getContext(), R.interpolator.decelerate_quint);

    public static final TimeInterpolator DECELERATE_QUART =
            AnimationUtils.loadInterpolator(HSApplication.getContext(), R.interpolator.decelerate_quart);

    public static final TimeInterpolator DECELERATE_TIRPLE =
            AnimationUtils.loadInterpolator(HSApplication.getContext(), R.interpolator.decelerate_triple);

    public static final TimeInterpolator DECELERATE_QUAD =
            AnimationUtils.loadInterpolator(HSApplication.getContext(), R.interpolator.decelerate_quad);
    ...
    public static Animator createIconAppearAnimation(final View icon, int delayFactor) {
        ...
        icon.setScaleX(0f);
        icon.setScaleY(0f);
        ValueAnimator bounceAnim = LauncherAnimUtils.ofPropertyValuesHolder(icon,

package com.acb.libwallpaper.live.desktop.news;
...
/**
 * Progress bar for news "refresh" and "load more" actions.
 */
public class LoadingProgressBar extends View {
    ...
    private static final int LOADING_TEXT_OFFSET_Y_PX = Dimensions.pxFromDp(13.3f);
    ...
    public LoadingProgressBar(Context context, AttributeSet attrs) {
        ...
        mBigCircleRadius = a.getDimension(R.styleable.LoadingProgressBar_prepareCircleRadius, Dimensions.pxFromDp(10));
        mSmallCircleRadius = a.getDimension(R.styleable.LoadingProgressBar_loadingCircleRadius, Dimensions.pxFromDp(5));
        mBigCircleDist = a.getDimension(R.styleable.LoadingProgressBar_prepareCircleDistance, Dimensions.pxFromDp(30));
        mSmallCircleDist = a.getDimension(R.styleable.LoadingProgressBar_loadingCircleDistance, Dimensions.pxFromDp(15));
        mVibrateRange = a.getDimension(R.styleable.LoadingProgressBar_loadingCircleVibrateRange, Dimensions.pxFromDp(3));

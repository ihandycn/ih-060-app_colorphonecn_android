...
/**
 * This class differs from {@link android.support.v7.widget.DefaultItemAnimator} in that it removes cross-fading
 * effect when item changes. This prevents unchanged area of changed items from flickering.
 */

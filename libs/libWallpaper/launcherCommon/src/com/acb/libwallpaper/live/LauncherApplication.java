...
import com.acb.libwallpaper.live.desktop.WallpaperChangedReceiver;
...
import com.acb.libwallpaper.live.util.PicCache;
                ...
                prefs.doOnce(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Preferences.get(LauncherFiles.DESKTOP_PREFS).putLong(
                                ThemeConstants.PREF_THEME_SET_TIME + ":" + com.acb.libwallpaper.live.LauncherConstants.LAUNCHER_PACKAGE_NAME,

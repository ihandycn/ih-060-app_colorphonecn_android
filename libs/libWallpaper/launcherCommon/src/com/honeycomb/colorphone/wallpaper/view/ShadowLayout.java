...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            cornerRadius = attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius, 4 * getResources().getDisplayMetrics().density);
            shadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, 4 * getResources().getDisplayMetrics().density);
            dx = attr.getDimension(R.styleable.ShadowLayout_sl_dx, 0);
            dy = attr.getDimension(R.styleable.ShadowLayout_sl_dy, 0);
            shadowColor = attr.getColor(R.styleable.ShadowLayout_sl_shadowColor, 0x88757575);
        } finally {
            attr.recycle();
        }
    }

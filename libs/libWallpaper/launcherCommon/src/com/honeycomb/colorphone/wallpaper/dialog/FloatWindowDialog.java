...
public abstract class FloatWindowDialog extends FrameLayout implements FloatWindowListener {
    ...
    /**
     * Set some dialogs a same tag. Use this tag to handle those dialogs.
     * eg. remove all those dialogs at same time.
     ...
     * A modal tip can be removed by {@link FloatWindowManager#dismissAnyModalTip()}.

...
import static com.honeycomb.colorphone.wallpaper.view.IndicatorMark.*;
...
public class AdvancedPageIndicator extends View {
    ...
    private List<MarkerType> mMarkList;
    private Map<MarkerType, Boolean> mMarkerVisible;
    ...
    public void addMarkers(List<MarkerType> list) {
        mMarkList.clear();
    ...
    public void addMarker(int x, MarkerType type) {
    ...
    public void updateMarker(int x, MarkerType type) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mIndicatorMark = new IndicatorMark(
                new Marker(MarkerType.CIRCLE, mIndicatorRadius + mCircleHorizontalPadding, mIndicatorRadius + mCircleVerticalPadding, mRadiusMin),
                new Marker(MarkerType.CIRCLE, mIndicatorRadius + mCircleHorizontalPadding, mIndicatorRadius + mCircleVerticalPadding, mIndicatorRadius),
                mIndicatorColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMarkList.get(getFirstVisibleIndex()) == MarkerType.RECT) radius = mRectRadius;
        if (mMarkList.get(getFirstVisibleIndex()) == MarkerType.PLUS_SIGN) radius = mPlusRadius;
        if (mIsRtl) {
    ...
    public void setIndex(int index) {
        ...
        if (mMarkList.get(index) == MarkerType.PLUS_SIGN) {
        ...
        } else if (mMarkList.get(index) == MarkerType.RECT) {
    ...
    public void onScrolling(int position, float offsetPercentage) {
        ...
        if (lastIndex >= 0 && lastIndex < mMarkList.size() && mMarkList.get(lastIndex) == MarkerType.PLUS_SIGN && (unifiedOffset > offsetM)) {
        ...
        if (unifiedPosition >= 0 && unifiedPosition < mMarkList.size()
                && mMarkList.get(unifiedPosition) == MarkerType.RECT && unifiedOffset < headMoveOffset) {

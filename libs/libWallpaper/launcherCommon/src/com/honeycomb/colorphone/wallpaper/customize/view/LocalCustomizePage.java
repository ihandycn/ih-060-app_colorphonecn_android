...
import com.honeycomb.colorphone.wallpaper.customize.adapter.LocalWallpaperGalleryAdapter;
import com.honeycomb.colorphone.wallpaper.customize.util.GridItemDecoration;
import com.honeycomb.colorphone.wallpaper.util.ViewUtils;
import com.honeycomb.colorphone.wallpaper.view.RecyclerViewAnimator;
import com.honeycomb.colorphone.wallpaper.view.recyclerview.SafeGridLayoutManager;
...
public class LocalCustomizePage extends LinearLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        com.honeycomb.colorphone.wallpaper.util.Utils.configTabLayoutText(tabs, Fonts.getTypeface(Fonts.Font.CUSTOM_FONT_SEMIBOLD), 14f);

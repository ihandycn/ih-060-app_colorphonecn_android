...
public class GuideHelper {
    ...
    public static void logWallpaperPreview(int type) {
        ...
        LauncherAnalytics.logEvent(name, true);
        if (isLive) {
            LauncherAnalytics.logEvent("Wallpaper_Live_Preview_Shown", true);
        }
    ...
    public static void logWallpaperApply(String wallpaperName) {
        ...
        LauncherAnalytics.logEvent(name, true, "type", wallpaperName);
        if (isLive) {
            LauncherAnalytics.logEvent("Wallpaper_Live_SetAsWallpaper_Btn_Clicked",
    ...
    private static void logLiveGestureCancel(long timeInterval) {
        ...
        LauncherAnalytics.logEvent("Wallpaper_Live_Gesture_Preview_Slided", "GestureShowedTime", paramValue);
    }
}

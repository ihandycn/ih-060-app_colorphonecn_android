package com.honeycomb.colorphone.wallpaper.customize.crop;// "Therefore those skilled at the unorthodox
...
final class CropWindowHandler {
     ...
     */
    public CropWindowMoveHandler getMoveHandler(float x, float y, float targetRadius, CropImageOptions.CropShape cropShape) {
        CropWindowMoveHandler.Type type = cropShape == CropImageOptions.CropShape.OVAL

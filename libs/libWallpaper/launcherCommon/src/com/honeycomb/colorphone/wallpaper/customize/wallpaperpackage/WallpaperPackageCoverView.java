package com.honeycomb.colorphone.wallpaper.customize.wallpaperpackage;
...
public class WallpaperPackageCoverView extends RelativeLayout implements INotificationObserver {
    ...
    public void setPackageInfo(WallpaperPackageInfo packageInfo) {
        ...
        GlideApp.with(getContext()).load(packageInfo.mAvatar).diskCacheStrategy(DiskCacheStrategy.DATA).into(mAvatar);
    }

...
public class PageIndicatorMarker extends FrameLayout {
    ...
    public void setMarkerDrawables(int activeResId, int inactiveResId) {
        mActiveMarker.setImageDrawable(ContextCompat.getDrawable(getContext(), activeResId));
        mInactiveMarker.setImageDrawable(ContextCompat.getDrawable(getContext(), inactiveResId));
    }
